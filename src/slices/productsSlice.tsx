...
const initialState: ProductType[] = [
  ...
  },
  {
    ...
    description:
      'Стружка кальмара,Стружка краба,Кільця кальмара,Кальмар Шанхайський,Кальмар Перуанський,Павутинка кальмара з перцем,Соломка тунця,Соломка тріски,Соломка тріски з перцем,Ікряник з лосося,Павутинка тунця з перцем,Палички вʼяленого лосося,Анчоус,Філе тріски,Бурштинова з перцем,Голд фіш, Ставридка',
    weight: [1700],
    category: 3,
  },
];
